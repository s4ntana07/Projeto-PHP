...
<div id="div-login-cadastro">
    ...
    <label></label>    
    <input type="text" name="nome" placeholder="Nome" class="input-cadastro"><br>

    <label></label>
    <input type="text" name="login" placeholder="Usuário" class="input-cadastro"><br>
 
    <label></label>
    <input type="password" name="senha" placeholder="Senha" class="input-cadastro"><br>
